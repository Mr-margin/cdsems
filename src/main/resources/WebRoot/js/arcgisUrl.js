...
//var ArcGisUrl = "http://10.100.244.19";
var ArcGisUrl = "http://192.168.1.119:8080";
...
function publicDingwei(lon,lat){
    ...
    require(["esri/map","esri/SpatialReference","esri/geometry/Extent","esri/dijit/InfoWindowLite",
        ...
        var pointSymbol = new dong.PictureMarkerSymbol("/cdsems/img/dian/tongyong.png", 32, 32);
...
function arcgisDw(lon,lat){
    // ajaxPost('/cdsems/tianditu/getAddress', {name:"国兴大厦"}).done(function (result) {
    //     console.log(result)
    // })
